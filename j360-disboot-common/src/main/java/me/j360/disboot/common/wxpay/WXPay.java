...
public class WXPay {
    ...
    public WXPay(final WXPayConfig config, final String notifyUrl, final boolean autoReport, final boolean useSandbox, WXPayConstants.SignType signType, String spbillCreateIp) throws Exception {
        this.config = config;
        this.notifyUrl = notifyUrl;
        this.autoReport = autoReport;
        this.useSandbox = useSandbox;
...
//        }
    ...
    public Map<String, String> fillRequestTransfersData(Map<String, String> reqData) throws Exception {
        ...
        reqData.put("spbill_create_ip", this.spbillCreateIp);
        reqData.put("desc","奖金发放");
        reqData.put("sign", WXPayUtil.generateSignature(reqData, config.getKey(), this.signType));
        return reqData;
    }
     ...
     * @throws Exception
     */
    public Map<String, String> fillResponseData(Map<String, String> reqData) throws Exception {
        reqData.put("appId", config.getAppID());
    ...
    public String generateSignature(final Map<String, String> data) throws Exception {
        return WXPayUtil.generateSignature(data , this.config.getKey());
    }
    ...
    public Map<String, String> processPromotionResponseXml(String xmlStr) throws Exception {
        String RETURN_CODE = "return_code";
        String return_code;
        Map<String, String> respData = WXPayUtil.xmlToMap(xmlStr);
        if (respData.containsKey(RETURN_CODE)) {
    ...
    public Map<String, String> promotionTransfers(Map<String, String> reqData) throws Exception {
        return this.promotionTransfers(reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
     ...
     * @throws Exception
     */
    public Map<String, String> promotionTransfers(Map<String, String> reqData,  int connectTimeoutMs, int readTimeoutMs) throws Exception {
        String url = WXPayConstants.MMPAYTRAMSFERS_URL_SUFFIX;
        String respXml = this.requestWithCert(url, this.fillRequestTransfersData(reqData), connectTimeoutMs, readTimeoutMs);
        return this.processPromotionResponseXml(respXml);
    }
